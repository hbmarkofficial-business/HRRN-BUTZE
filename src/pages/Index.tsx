  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Braunschweig | HRRN BUTZE</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop HRRN BUTZE in Braunschweig für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="HRRN BUTZE | Premium Barbershop Braunschweig" />
        <meta
        ...
        <meta name="twitter:title" content="HRRN BUTZE | Premium Barbershop Braunschweig" />
        <meta
